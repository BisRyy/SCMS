...
public class Orders extends JPanel {
	private JTextField textField;
		...
		lblNewLabel.setBounds(48, 26, 108, 39);
		lblNewLabel.setForeground(Color.WHITE);
		add(lblNewLabel);
		
		textField = new JTextField();
		textField.setBounds(166, 31, 260, 29);
		add(textField);
		textField.setColumns(10);
		
		JPanel panel = new JPanel();
		panel.setBounds(31, 77, 356, 175);
		...
		btnNewButton_9_1.setBounds(427, 666, 119, 21);
		add(btnNewButton_9_1);
		
		JButton btnNewButton_9 = new JButton("Next page");
		btnNewButton_9.setBounds(664, 666, 119, 21);
		add(btnNewButton_9);
		
		JPanel panel_2 = new JPanel();
		panel_2.setLayout(null);
		panel_2.setBackground(Color.WHITE);
		panel_2.setBounds(427, 77, 356, 175);
		add(panel_2);
		...
		panel_4.setBounds(833, 77, 356, 175);
		add(panel_4);
		...
		panel_1.setBounds(31, 262, 356, 173);
		add(panel_1);
		...
		panel_3.setBounds(427, 262, 356, 173);
		add(panel_3);
		...
		panel_5.setBounds(833, 262, 356, 173);
		add(panel_5);
		...
		panel_6.setBounds(31, 445, 356, 173);
		add(panel_6);
		...
		panel_7.setBounds(427, 445, 356, 173);
		add(panel_7);
		...
		panel_8.setBounds(833, 445, 356, 173);
		add(panel_8);
