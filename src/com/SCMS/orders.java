...
public class orders extends JPanel {
	...
	public orders() {
		...
		lblNewLabel_3.setBounds(10, 79, 45, 13);
		panel.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("Price");
		lblNewLabel_4.setBounds(10, 102, 45, 13);
		...
		lblNewLabel_6.setBounds(216, 56, 45, 13);
		panel.add(lblNewLabel_6);
		
		JLabel lblNewLabel_7 = new JLabel("TV");
		lblNewLabel_7.setBounds(216, 79, 45, 13);
		panel.add(lblNewLabel_7);
		
		JLabel lblNewLabel_8 = new JLabel("2800$");
		lblNewLabel_8.setBounds(216, 102, 45, 13);
		panel.add(lblNewLabel_8);
		
		JLabel lblNewLabel_9 = new JLabel("cancelled");
		lblNewLabel_9.setBounds(216, 125, 45, 13);
		panel.add(lblNewLabel_9);
		
		JPanel panel_1 = new JPanel();
		panel_1.setLayout(null);
		panel_1.setBounds(31, 261, 271, 164);
		add(panel_1);
		...
		lblNewLabel_2_1.setBounds(10, 56, 45, 13);
		panel_1.add(lblNewLabel_2_1);
		
		JLabel lblNewLabel_3_1 = new JLabel("Products");
		lblNewLabel_3_1.setBounds(10, 79, 45, 13);
		panel_1.add(lblNewLabel_3_1);
		
		JLabel lblNewLabel_4_1 = new JLabel("Price");
		lblNewLabel_4_1.setBounds(10, 102, 45, 13);
		...
		panel_2.setBounds(438, 87, 271, 164);
		add(panel_2);
		...
		lblNewLabel_2_2.setBounds(10, 56, 45, 13);
		panel_2.add(lblNewLabel_2_2);
		
		JLabel lblNewLabel_3_2 = new JLabel("Products");
		lblNewLabel_3_2.setBounds(10, 79, 45, 13);
		panel_2.add(lblNewLabel_3_2);
		
		JLabel lblNewLabel_4_2 = new JLabel("Price");
		lblNewLabel_4_2.setBounds(10, 102, 45, 13);
		...
		panel_3.setBounds(438, 261, 271, 164);
		add(panel_3);
